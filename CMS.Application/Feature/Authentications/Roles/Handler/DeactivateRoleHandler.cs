...
{
    public class DeactivateRoleHandler(IRoleServices roleServices) : IRequestHandler<DeactivateMenu, IResult<int>>
    {
        public async Task<IResult<int>> Handle(DeactivateMenu request, CancellationToken cancellationToken)
        {
